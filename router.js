...
function buildRouter() {
  ...
  router.post('/bookings/:id/cancel',   requireAuth, wrap(r => store.cancelBooking(r.params.id, r.body.reason)));
  ...
  router.post('/products/:id/update',   requireAuth, wrap(r => store.updateProduct(r.params.id, r.body.price, r.body.in_stock,
    { name: r.body.name, name_hi: r.body.name_hi, category: r.body.category, unit: r.body.unit })));
  ...
  router.get ('/catalog',               requireAuth, wrap(()  => store.catalogList()));
  router.post('/catalog',               requireAuth, wrap(r => store.addCatalogItem(r.body)));
  router.post('/catalog/:key/remove',   requireAuth, wrap(r => store.removeCatalogItem(r.params.key)));
